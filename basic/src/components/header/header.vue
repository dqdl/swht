...
/*
* @Author: hdw
* @Date: 2022-01-11 17:34:29
 * @Last Modified by: mikey.zhaopengkey.zhaopeng
 * @Last Modified time: 2022-02-10 15:06:066
*/
<template>
    <div class="header">
        <div class="left">
        ...
        <div class="right">
            <div class="nowTime">
                <n-gradient-text :gradient="{ from: '#E9F4FF', to: '#B1C5D8' }">{{ nowTime }}</n-gradient-text>
            </div>
            <div class="weather">
                <p></p>
                <p>
            ...
            <div class="rightH" style="position: reactive;">
                <div>
                    <n-gradient-text :gradient="{ from: '#E9F4FF', to: '#B1C5D8' }">
                        ...
                        <img
                            @click="clickImg"
                            class="fade-mune-img"
                            src="../../assets/images/header/buttom.png"
                        />
                    </n-gradient-text>
            ...
            <div class="rightR">
                <n-gradient-text @click="logout" :gradient="{ from: '#E9F4FF', to: '#B1C5D8' }">退出</n-gradient-text>
            </div>
        </div>
        <transition name="fade-choice">
...
import Login from '../../axios/api/login/index'
import PersonalPage from '@/pages/personalCenter/index.vue'
