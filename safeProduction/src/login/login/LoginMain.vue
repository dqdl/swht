...
// import yonghu from '@/assets/images/login/yonghu.png';
// import qiyeyonghuguanli from '@/assets/images/login/qiyeyonghuguanli.png';
// 登陆数据;
		...
		.login_switch {
			...
			.activ {
				...
				.img {
					...
					height: 36px;
					margin-right: 6px;
					background: url('@/assets/images/yonghu.png');
					background-size: 100%;
				}
				.img2 {
					width: 36px;
					height: 36px;
					margin-right: 6px;
					background: url('@/assets/images/qiyeyonghuguanli.png');
					background-size: 100%;
				}
			}
			.active {
