    ...
    <div class="resetpwd">
        <div class="resetpwd_box">
            <div class="resetpwd_switc">
                <div>
                    <div :class="resetpwdData.componentActive == 'account' ? 'active' : ''">
                        <div class="resetpwd_p">1</div>
                        <div>确定账户</div>
                    </div>
                    <div></div>
                    <div :class="resetpwdData.componentActive == 'verification' ? 'active' : ''">
                        <div class="resetpwd_p">2</div>
                        <div>安全验证</div>
                    </div>
                    <div></div>
                    <div :class="resetpwdData.componentActive == 'submit' ? 'active' : ''">
...
const componentChange = (name: string) => {
    ...
    switch (name) {
        case 'verification': (resetpwdData.componentNmae as any) = verification;
            break;
        default:
