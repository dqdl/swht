...
import { defineComponent, reactive, h, ref, watch, onMounted } from 'vue';
...
let tableData: any = ref([
	// { num: 1, type: '管委会发文', content: '', title: 'Wonderwall', topic: '主题', createuserName: '张三', sendTime: '2022-2-16', sendNumber: 11, readRange: '50%', downloadRange: '50%', status: false},
	// { num: 2, type: '管委会发文', content: '', title: "Don't Look Back in Anger", topic: '主题', createuserName: '张三', sendTime: '2022-2-16', sendNumber: 11, readRange: '50%', downloadRange: '50%', status: false},
	// { num: 3, type: '管委会发文', content: '', title: 'Champagne Supernova', topic: '主题', createuserName: '张三', sendTime: '2022-2-16', sendNumber: 11, readRange: '50%', downloadRange: '50%', status: true},
	// { num: 4, type: '管委会发文', content: '', title: 'Champagne Supernova', topic: '主题', createuserName: '张三', sendTime: '2022-2-16', sendNumber: 11, readRange: '50%', downloadRange: '50%', status: true}
]);
...
const getList = (params: any = { current: 1 }) => {
	...
	const data = { ...basicData, ...params, type: 0 };
