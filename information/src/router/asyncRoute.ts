export const asyncRoute = [
	{
		...
		children: [
				...
				children: [
					{
						...
						component:
							'organizeManagement/NumberOfManagementCommitteeDepartments',
						label: '管委会部门数',
						key: '管委会部门数',
			...
			{
				path: '/coreSystem/Generaldictionarymanagement',
			...
			{
				path: '/coreSystem/SystemDictionaryManagement',
