  ...
  <div class="loginmain">
    <div class="login_box">
      ...
      <div class="login_switch">
        <div @click="loginChange(true)" :class="loginData.active ? 'active' : ''">
          <img src="@/assets/icon/login/yonghu.png" />
          <span>管委会用户</span>
        </div>
        <div @click="loginChange(false)" :class="!loginData.active ? 'active' : ''">
      ...
      <div class="login_details">
        ...
        <div v-if="loginData.active">
          <LoginDetails :userBox="loginData.user" />
        </div>
        <!-- 企业用户登录 -->
        <div v-else>
          <LoginDetails :userBox="loginData.company" />
        </div>
      </div>
    </div>
  </div>
